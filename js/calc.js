...
window.Calc = {
  ...
  // Reprend le Google Form d'accueil. t: "num"=nombre, "area"=texte long, sinon texte court.
  // Rempli UNE FOIS par la cliente. Réponses stockées en jsonb {id: valeur}.
  QI: [
    { id:"entrainement_freq", q:"Combien de fois par semaine veux-tu t’entraîner ?", t:"num" },
    { id:"age", q:"Quel âge as-tu ?", t:"num" },
    { id:"rythme_vie", q:"Comment décrirais-tu ton rythme de vie actuel ?", t:"area" },
    { id:"grossesses", q:"As-tu déjà eu une ou plusieurs grossesses ? Si oui, combien ? Rééducation périnéale ? Diastasis connu ?", t:"area" },
    { id:"travail_posture", q:"Durant ta journée de travail, tu es plutôt :" },
    { id:"journees", q:"Tes journées sont plutôt :" },
    { id:"fatigue_soir", q:"Ressens-tu souvent de la fatigue en fin de journée ? Si oui, de quel type ? (physique, mentale, manque de motivation…)", t:"area" },
    { id:"sommeil_heures", q:"En moyenne, tu dors combien d’heures par nuit ?" },
    { id:"reveil_fatigue", q:"Te réveilles-tu fatiguée le matin ?" },
    { id:"sommeil_reparateur", q:"Dirais-tu que ton sommeil est réparateur ?" },
    { id:"cafe", q:"Consommes-tu régulièrement du café ou des boissons énergisantes ? Si oui, combien par jour ?", t:"area" },
    { id:"tabac", q:"Tu fumes ? Si oui, depuis combien de temps ? Et combien par jour ?", t:"area" },
    { id:"alcool", q:"Tu bois de l’alcool ? Si oui, à quelle fréquence ?" },
    { id:"complements", q:"Prends-tu actuellement des compléments alimentaires ?" },
    { id:"fatigue_frequente", q:"Te sens-tu souvent fatiguée ou sans énergie ?" },
    { id:"energie_actuelle", q:"Sur une échelle de 1 à 10, comment évalues-tu ton niveau d’énergie actuel ? ⚡", t:"num" },
    { id:"antecedents", q:"As-tu des antécédents médicaux importants ou des événements de santé passés que je devrais connaître ?", t:"area" },
    { id:"traitement", q:"Suis-tu actuellement un traitement ou un suivi particulier ? Si oui, lequel ?", t:"area" },
    { id:"douleurs_effort", q:"As-tu déjà ressenti des gênes ou douleurs pendant l’effort ?", t:"area" },
    { id:"amenagements", q:"As-tu besoin d’aménagements spécifiques pendant les séances ?", t:"area" },
    { id:"appetit", q:"Ton appétit est-il plutôt stable, variable, ou parfois absent ?" },
    { id:"envies", q:"As-tu des envies de sucre ou de salé quand tu es fatiguée ?" },
    { id:"ressenti_corps", q:"Peux-tu décrire comment tu te sens dans ton corps en ce moment ?", t:"area" },
    { id:"petit_dej", q:"Déjeunes-tu le matin ?" },
    { id:"petit_dej_quoi", q:"Si oui, qu’est-ce que tu prends en général pour le petit-déjeuner ?", t:"area" },
    { id:"journee_repas", q:"Peux-tu me décrire une journée type de repas ?", t:"area" },
    { id:"grignotage", q:"As-tu tendance à grignoter entre les repas ?" },
    { id:"regime", q:"As-tu déjà testé une méthode alimentaire ou un régime ?", t:"area" },
    { id:"sport_passe", q:"As-tu déjà pratiqué une activité sportive ? Si oui laquelle ?", t:"area" },
    { id:"pref_seances", q:"Tu préfères des séances plutôt :" },
    { id:"objectifs", q:"Quels sont tes objectifs principaux avec ce coaching ?", t:"area" },
    { id:"objectifs_pourquoi", q:"Pourquoi ces objectifs sont-ils importants pour toi aujourd’hui ?", t:"area" },
    { id:"zone_prio", q:"Quelle zone du corps veux-tu prioriser, pour quel(s) objectif(s) ?", t:"area" },
    { id:"court_terme", q:"Qu’aimerais-tu constater sur ton corps ou ton énergie à court terme ?", t:"area" },
    { id:"long_terme", q:"Et sur le long terme, quel est ton grand objectif forme / santé / résultats ?", t:"area" },
    { id:"pourquoi_moi", q:"Qu’est-ce qui t’a donné envie de commencer ce coaching avec moi ? 💬", t:"area" },
    { id:"motivation", q:"Sur une échelle de 1 à 10, à quel point es-tu motivée à reprendre le sport ? 🔥", t:"num" },
    { id:"freins", q:"Qu’est-ce qui t’a empêchée jusqu’ici d’atteindre tes résultats ?", t:"area" },
    { id:"attentes_coach", q:"Qu’attends-tu le plus de moi en tant que coach ?", t:"area" },
    { id:"evenement", q:"As-tu un événement ou une période qui te motive particulièrement à atteindre tes objectifs ?", t:"area" },
    { id:"taille", q:"Taille (en cm)", t:"num" },
    { id:"poids", q:"Poids actuel (en kg)", t:"num" },
    { id:"tour_taille", q:"Tour de taille (au niveau le plus fin du ventre)", t:"num" },
    { id:"tour_hanches", q:"Tour de hanches (au niveau des os du bassin)", t:"num" },
    { id:"tour_fesses", q:"Tour de fesses (au point le plus bombé)", t:"num" },
    { id:"tour_cuisse", q:"Tour de cuisse (haut de cuisse, à 10 cm sous le pli fessier)", t:"num" },
    { id:"tour_poitrine", q:"Tour de poitrine (avec dos)", t:"num" },
    { id:"tour_dos", q:"Tour de dos (juste sous la poitrine)", t:"num" },
    { id:"tour_bras", q:"Tour de bras (milieu du biceps, bras détendu)", t:"num" },
    { id:"photos_depart", q:"📸 Souhaites-tu m’envoyer tes photos de départ pour ton suivi visuel ?" },
    { id:"creneaux", q:"Quels jours / créneaux horaires ?", t:"area" },
    { id:"lieu_entrainement", q:"Tu t’entraînes :" },
    { id:"materiel", q:"Quel matériel as-tu ? (pour les programmes distanciels)", t:"area" },
    { id:"depuis_quand", q:"Depuis combien de temps t’entraînes-tu ? (si tu t’entraînes)" },
    { id:"retours_technique", q:"Es-tu prête à envoyer des retours (photos/vidéos) pour corriger ta technique ?" },
    { id:"type_accompagnement", q:"Quel type d’accompagnement souhaites-tu ?" },
  ],
};
